...
int main()
{
    ...
    Shader ourTexShader("shaders/shader_tex.vs", "shaders/shader_tex.frag");
    Shader lightShader("shaders/shader_light.vs", "shaders/shader_light.frag");
    Shader floorShader("shaders/floor_shader.vs", "shaders/floor_shader.frag");
    Shader screenShader2("shaders/screen.vs", "shaders/screen3.frag");
    Shader screenShader("shaders/screen.vs", "shaders/screen.frag");
    Shader normalShader("shaders/normal.vs", "shaders/normal.frag");
    Shader parallaxShader("shaders/parallax.vs", "shaders/parallax.frag");
    Shader hardShader("shaders/hard_light.vs", "shaders/hard_light.frag");
    Shader skyboxShader("shaders/skybox_shader.vs", "shaders/skybox_shader.frag");
 ...
 */
    std::vector<std::string> faces
    {
        ...
        "skybox/Lycksele3/negx.jpg",
        "skybox/Lycksele3/posy.jpg",
        "skybox/Lycksele3/negy.jpg",
        "skybox/Lycksele3/posz.jpg",
        "skybox/Lycksele3/negz.jpg"
    };
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        for(int i = 1; i < 4; ++i) {
            ourShader.Use();
                ...
                model = glm::translate(model, glm::vec3(3.0 - i, 0.0, -2.0 - i * i));
                view = camera.GetViewMatrix();
                ...
                lightColorLoc  = glGetUniformLocation(ourShader.Program, "lightColor");
                lightPosLoc    = glGetUniformLocation(ourShader.Program, "lightPos");
            
                glUniform3f(objectColorLoc, 0.5f, 0.5f, 0.5f);
                glUniform3f(lightColorLoc, 1.0f, 1.0f, 1.0f);
                glUniform3f(lightPosLoc, lightPos.x, lightPos.y, lightPos.z);
            
                glUniform1f(glGetUniformLocation(ourShader.Program, "ambientStrength"), 0.1f);
                glUniform1f(glGetUniformLocation(ourShader.Program, "specularStrength"), 0.5f);
                glUniform1f(glGetUniformLocation(ourShader.Program, "shininess"), 32);
                glUniform1f(glGetUniformLocation(ourShader.Program, "constant"), 1.0f);
                glUniform1f(glGetUniformLocation(ourShader.Program, "linear"), 0.09f);
                glUniform1f(glGetUniformLocation(ourShader.Program, "quadratic"), 0.032f);
